...
with open("S:\\11В_2023_2024\\Цыганков Дмитрий\\Мегаполис потенциал\\students(1).csv", encoding="utf8") as csvfile:
...
with open("S:\\11В_2023_2024\\Цыганков Дмитрий\\Мегаполис потенциал\\students(1).csv", 'w', newline='', encoding='utf-8') as file:
  w = csv.writer(file)
